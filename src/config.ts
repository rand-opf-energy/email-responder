export const CONFIG = {
    ...
    VALID_TARGET_EMAILS: [
        "reservations@sanmarinotennis.org",
        "membership@sanmarinotennis.org",
        "programs@sanmarinotennis.org"
    ],

    // The canned response sent when an email is sent directly to the bot's address
    CANNED_DIRECT_MESSAGE: "Hi there! It looks like you emailed me directly. Please make sure to email reservations@sanmarinotennis.org, membership@sanmarinotennis.org, or programs@sanmarinotennis.org instead for assistance!",
